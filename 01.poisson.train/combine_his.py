...
if __name__ == '__main__':
    ...
    # Load Data
    with open('./China_poisson_prcp.pkl', 'rb') as f:
        data_dict = pickle.load(f)
    bigPr_poisson_tr, bigPr_poisson_pr = \
      data_dict['bigPr_poisson_tr'], data_dict['bigPr_poisson_pr']
    
    bigPr_poisson_tr, bigPr_poisson_pr = \
        bigPr_poisson_tr.reshape(42, 365, Nlat, Nlon), bigPr_poisson_pr.reshape(14, 365, Nlat, Nlon)

    bigPr_poisson_new = combine_data(bigPr_poisson_tr, bigPr_poisson_pr)

    with open('China_his_prcp.pkl', 'wb') as f:
        pickle.dump({'bigPr_poisson_his': bigPr_poisson_new}, f, protocol=4)
