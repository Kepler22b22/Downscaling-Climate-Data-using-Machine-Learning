...
if __name__ == '__main__':
    ...
    with open('../../../02.ann.BiasCorrection/1-non/China_his_temp_weightmean.pkl', 'rb') as f:
    ...
    with open('../../../02.ann.BiasCorrection/1-non/China_his_temp_weightmean_else.pkl', 'rb') as f:
        data_dict = pickle.load(f)
    ...
    with open('China_talyor_ccsm_1non.pkl', 'wb') as f:
