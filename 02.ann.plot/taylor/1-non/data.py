...
if __name__ == '__main__':
    ...
    with open('../../../02.ann.BiasCorrection/1-non/Beijing_his_temp_postwork.pkl', 'rb') as f:
    ...
    with open('Beijing_talyor_ccsm_1non.pkl', 'wb') as f:
        pickle.dump({'bigMax_ann_his': bigMax_ann_his, 
                     'bigMin_ann_his': bigMin_ann_his}, f, protocol=4)
