...
def job_readdata_2(clon, clat):
    ...
    #fCmax = xr.open_dataset('../../data/ccsm4/future/ccsm_tasmax_2006-2100_rcp85.nc')
    #fCmin = xr.open_dataset('../../data/ccsm4/future/ccsm_tasmin_2006-2100_rcp85.nc')
...
def job_save(name, j, i, lon, lat, xCp, xGp_ann):
    fname = "./out_temp_rcp85/ann_data_temp_rcp85." + name
    f = sh.open(fname)
    f['dataid'] = name
...
if __name__ == '__main__':
    ...
    with open('../../data/ccsm4/future/ccsm_rcp_tmax.pkl', 'rb') as f:
        data_dict = pickle.load(f)
    bigMax_ccsm_pr = data_dict['bigMax_ccsm_rcp85'] 

    with open('../../data/ccsm4/future/ccsm_rcp_tmin.pkl', 'rb') as f:
        data_dict = pickle.load(f)
    bigMin_ccsm_pr = data_dict['bigMin_ccsm_rcp85']
