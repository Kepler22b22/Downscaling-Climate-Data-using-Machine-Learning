...
if __name__ == '__main__':
    ...
    #with open('../../../Downscaling-2020-10/CCSM_case/03.bc.test/China_bc_prcp.pkl', 'rb') as f:
    #    data_dict = pickle.load(f)
    #bigPr_bc_rcp26, bigPr_bc_rcp85 = \
    #    data_dict['bigPr_pr_rcp26'], data_dict['bigPr_pr_rcp85']

    #with open('../../../Downscaling-2020-10/data/ccsm4/future/ccsm_rcp_prcp.pkl', 'rb') as f:
    #    data_dict = pickle.load(f)
    #bigPr_ccsm_rcp26, bigPr_ccsm_rcp85 = data_dict['bigPr_ccsm_rcp26'], data_dict['bigPr_ccsm_rcp85']

    #bigPr_bc_rcp26, bigPr_bc_rcp85 = \
    #    bigPr_bc_rcp26.reshape(95, 365, 160, 280), \
    #    bigPr_bc_rcp85.reshape(95, 365, 160, 280)

    #bigPr_bc_rcp26, bigPr_bc_rcp85 = \
    #    monthlymean(bigPr_bc_rcp26) * 86400, \
    #    monthlymean(bigPr_bc_rcp85) * 86400

    #bigPr_ccsm_rcp26, bigPr_ccsm_rcp85 = \
    #    bigPr_ccsm_rcp26.values.reshape(95, 365, 42, 57), \
    #    bigPr_ccsm_rcp85.values.reshape(95, 365, 42, 57)

    #bigPr_ccsm_rcp26, bigPr_ccsm_rcp85 = \
    #    monthlymean(bigPr_ccsm_rcp26) * 86400, \
    #    monthlymean(bigPr_ccsm_rcp85) * 86400

    #with open('China_historical_prcp.pkl', 'wb') as f:
    #    pickle.dump({'bigPr_bc_his': bigPr_bc_his,
    #                 'bigPr_ccsm_his': bigPr_ccsm_his,
    #                 'bigPr_cru_his': bigPr_cru_his}, f, protocol=4)
    
    #with open('China_future_prcp.pkl', 'wb') as f:
    #    pickle.dump({'bigPr_bc_rcp26': bigPr_bc_rcp26, 
    #                 'bigPr_bc_rcp85': bigPr_bc_rcp85, 
    #                 'bigPr_ccsm_rcp26': bigPr_ccsm_rcp26, 
    #                 'bigPr_ccsm_rcp85': bigPr_ccsm_rcp85}, f, protocol=4)

    with open('./China_historical_prcp.pkl', 'rb') as f:
        data_dict = pickle.load(f)
    bigPr_bc_his, bigPr_ccsm_his, bigPr_cru_his = \
        data_dict['bigPr_bc_his'],\
        data_dict['bigPr_ccsm_his'], \
        data_dict['bigPr_cru_his']

    with open('./China_future_prcp.pkl', 'rb') as f:
        data_dict = pickle.load(f)
    bigPr_bc_rcp26, bigPr_bc_rcp85, bigPr_ccsm_rcp26, bigPr_ccsm_rcp85 = \
        data_dict['bigPr_bc_rcp26'], data_dict['bigPr_bc_rcp85'], \
    ...
    for i in range(0, 5):
        ...
        yCpr_rcp26_near_raw[:, i] = bigPr_ccsm_rcp26[14:45, 6, latC[i], lonC[i]]
        yCpr_rcp85_near_raw[:, i] = bigPr_ccsm_rcp85[14:45, 6, latC[i], lonC[i]]
        yCpr_rcp26_long_raw[:, i] = bigPr_ccsm_rcp26[64:95, 6, latC[i], lonC[i]]
        yCpr_rcp85_long_raw[:, i] = bigPr_ccsm_rcp85[64:95, 6, latC[i], lonC[i]]
        yApr_rcp26_near_raw[:, i] = bigPr_bc_rcp26[14:45, 6, latA[i], lonA[i]]
        yApr_rcp85_near_raw[:, i] = bigPr_bc_rcp85[14:45, 6, latA[i], lonA[i]]
        yApr_rcp26_long_raw[:, i] = bigPr_bc_rcp26[64:95, 6, latA[i], lonA[i]]
        yApr_rcp85_long_raw[:, i] = bigPr_bc_rcp85[64:95, 6, latA[i], lonA[i]]
    ...
    plot2d(19, x=[x_array, x_array, x_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array], 
           ...
           ti='(c) Pr (July)',
           xl='Year', yl='Pr (Celsius)',
           #xlim=[minX, maxX],
           ylim=[minX, maxX],
           figsize=(13, 6),
           fn='./figures_future/plot-prcp-future-Huabei.pdf')
    ...
    plot2d(19, x=[x_array, x_array, x_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array], 
           ...
           ylim=[minX, maxX],
           figsize=(13, 6),
           fn='./figures_future/plot-prcp-future-Dongbei.pdf')
    ...
    plot2d(19, x=[x_array, x_array, x_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array], 
           ...
           ylim=[minX, maxX],
           figsize=(13, 6),
           fn='./figures_future/plot-prcp-future-Huadong.pdf')
    ...
    plot2d(19, x=[x_array, x_array, x_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array], 
           ...
           ylim=[minX, maxX],
           figsize=(13, 6),
           fn='./figures_future/plot-prcp-future-Huazhong.pdf')
    ...
    plot2d(19, x=[x_array, x_array, x_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array], 
           ...
           ylim=[minX, maxX],
           figsize=(13, 6),
           fn='./figures_future/plot-prcp-future-Huanan.pdf')
    ...
    plot2d(19, x=[x_array, x_array, x_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array], 
           ...
           ylim=[minX, maxX],
           figsize=(13, 6),
           fn='./figures_future/plot-prcp-future-Xinan.pdf')
    ...
    plot2d(19, x=[x_array, x_array, x_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x1_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array, x2_array], 
           ...
           ylim=[minX, maxX],
           figsize=(13, 6),
           fn='./figures_future/plot-prcp-future-Xibei.pdf')
