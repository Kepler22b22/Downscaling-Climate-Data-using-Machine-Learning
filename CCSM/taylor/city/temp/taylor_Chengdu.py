...
if __name__ == '__main__':
    ...
    bigMax_ann_his, bigMin_ann_his = \
        bigMax_ann_his[20:50, :, 62, 136], bigMin_ann_his[20:50, :, 62, 136]

    bigMax_ann_his, bigMin_ann_his = \
        monthlymean(bigMax_ann_his), monthlymean(bigMin_ann_his)

    bigMax_ann_his_1non, bigMin_ann_his_1non = \
        bigMax_ann_his_1non[20:50, :, 62, 136], bigMin_ann_his_1non[20:50, :, 62, 136]
    ...
    bigMax_ccsm_his, bigMin_ccsm_his = \
        bigMax_ccsm_his[:, 16, 27], bigMin_ccsm_his[:, 16, 27]
    ...
    bigMax_cru_his, bigMin_cru_his = \
        bigMax_cru_his[20:50, :, 241, 568], bigMin_cru_his[20:50, :, 241, 568]
    ...
    with open('Chengdu_talyor_ccsm.pkl', 'wb') as f:
