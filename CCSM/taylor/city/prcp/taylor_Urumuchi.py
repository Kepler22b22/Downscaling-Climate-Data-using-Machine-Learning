...
if __name__ == '__main__':
    ...
    bigPr_bc_his = bigPr_bc_his[20:50, :, 115, 70]
    bigPr_bc_his = monthlymean(bigPr_bc_his)

    bigPr_ann_his = bigPr_ann_his[20:50, :, 115, 70]
    bigPr_ann_his = monthlymean(bigPr_ann_his)

    bigPr_lr_his = bigPr_lr_his[20:50, :, 115, 70]
    bigPr_lr_his = monthlymean(bigPr_lr_his)

    bigPr_poisson_his = bigPr_poisson_his[20:50, :, 115, 70]
    bigPr_poisson_his = monthlymean(bigPr_poisson_his)

    bigPr_ccsm_his = bigPr_ccsm_his[:, 14, 30]
    ...
    bigPr_cru_his = bigPr_cru_his[20:50, :, 267, 535]
