...
if __name__ == '__main__':
    ...
    for i in range(0, 7):
        ...
        taylor_stats1 = sm.taylor_statistics(data['bigMax_ann_his_1non'], data['bigMax_cru_his'], 'data')
        taylor_stats2 = sm.taylor_statistics(data['bigMax_lr_his'], data['bigMax_cru_his'], 'data')
        taylor_stats3 = sm.taylor_statistics(data['bigMax_ann_his'], data['bigMax_cru_his'], 'data') 
        taylor_stats4 = sm.taylor_statistics(data['bigMax_ccsm_his'], data['bigMax_cru_his'], 'data')

        # Store statistics in arrays
        sdev_tmax = np.array([taylor_stats1['sdev'][0], taylor_stats1['sdev'][1],
                              taylor_stats2['sdev'][1], taylor_stats3['sdev'][1], 
                              taylor_stats4['sdev'][1]])
        crmsd_tmax = np.array([taylor_stats1['crmsd'][0], taylor_stats1['crmsd'][1],
                               taylor_stats2['crmsd'][1], taylor_stats3['crmsd'][1], 
                               taylor_stats4['crmsd'][1]])
        ccoef_tmax = np.array([taylor_stats1['ccoef'][0], taylor_stats1['ccoef'][1],
        ...
        sm.taylor_diagram(sdev_tmax, crmsd_tmax, ccoef_tmax, alpha=0.0, tickRMSangle = 115,
        ...
        # Write plot to file
        plt.savefig('./figures/taylor_tmax_' + city[i] + '.png')
        plt.close()
