...
if __name__=='__main__':
    ...
    yapr_max = np.mean(bigMax_ann_rcp26[14:44, 6, :, :], axis=0)
    yapr_min = np.mean(bigMin_ann_rcp26[14:44, 0, :, :], axis=0)
    ycpr_max = np.mean(bigMax_ccsm_rcp26[14:44, 6, :, :], axis=0)
    ycpr_min = np.mean(bigMin_ccsm_rcp26[14:44, 0, :, :], axis=0)
    ...
    my.plot2d_map(yCpr_max, Lon, Lat,
                  ...
                  ti='', fout = './figures/subplot-tmax-ccsm-rcp26-1.pdf' )

    my.plot2d_map(yApr_max, lon, lat,
                  levs = np.arange(-6.5, 6.5, 0.5), 
                  domain = [17, 54, 70, 140],
                  cbar = 'seismic', cbarstr = '',
                  ti='', fout = './figures/subplot-tmax-ann-rcp26-1.pdf' )
    ...
    my.plot2d_map(yCpr_min, Lon, Lat,
                  ...
                  domain = [17, 54, 70, 140],
                  cbar = 'seismic', cbarstr = '',
                  ti='', fout = './figures/subplot-tmin-ccsm-rcp26-1.pdf' )

    my.plot2d_map(yApr_min, lon, lat,
                  levs = np.arange(-6.5, 6.5, 0.5), 
                  domain = [17, 54, 70, 140],
                  cbar = 'seismic', cbarstr = '',
                  ti='', fout = './figures/subplot-tmin-ann-rcp26-1.pdf' )
