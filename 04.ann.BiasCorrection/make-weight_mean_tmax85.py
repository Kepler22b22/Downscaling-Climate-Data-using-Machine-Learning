...
if __name__ == '__main__':
    ...
    #Load data
    with open('./China_tmax_post_rcp85.pkl', 'rb') as f:
        data_dict = pickle.load(f)
    bigMax_ann_rcp85 = data_dict['bigMax_ann_rcp85']
    
    bigMax_ann_rcp85 = np.squeeze(np.array(bigMax_ann_rcp85))
    bigMax_ann_rcp85 = weight_mean(bigMax_ann_rcp85)

    with open('China_rcp85_tmax_weightmean.pkl', 'wb') as f:
        pickle.dump({'bigMax_ann_rcp85_weight': bigMax_ann_rcp85}, f, protocol = 4)
