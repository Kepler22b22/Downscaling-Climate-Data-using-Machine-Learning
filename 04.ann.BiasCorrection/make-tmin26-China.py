...
if __name__ == '__main__':
    ...
    bigMin_ann_rcp26 = \
        bigMin_ann_rcp26.reshape(95, 365, Nlat, Nlon)

    bigMin_ground_his = bigMin_ground_his.values.reshape(56, 365, Nlat, Nlon)

    bigMin_ann_rcp26 = \
        postwork(alpha_tmin, bigMin_ann_his, bigMin_ann_rcp26, bigMin_ground_his), \

    with open('China_tmin_post_rcp26.pkl', 'wb') as f:
        pickle.dump({'bigMin_ann_rcp26': bigMin_ann_rcp26}, f, protocol=4)
