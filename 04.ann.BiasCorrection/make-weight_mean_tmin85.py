...
if __name__ == '__main__':
    ...
    #Load data
    with open('./China_tmin_post_rcp8.pkl', 'rb') as f:
        data_dict = pickle.load(f)
    bigMin_ann_rcp85 = data_dict['bigMin_pr_rcp85']
    
    bigMin_ann_rcp85 = np.squeeze(np.array(bigMin_ann_rcp85))
    bigMin_ann_rcp85 = weight_mean(bigMin_ann_rcp85)

    with open('China_rcp8_tmin_weightmean.pkl', 'wb') as f:
        pickle.dump({'bigMin_ann_rcp85_weight': bigMin_ann_rcp85}, f, protocol = 4)
