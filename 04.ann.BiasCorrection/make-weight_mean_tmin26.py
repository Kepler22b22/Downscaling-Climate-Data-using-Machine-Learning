...
if __name__ == '__main__':
    ...
    #Load data
    with open('./China_tmin_post_rcp26.pkl', 'rb') as f:
        data_dict = pickle.load(f)
    bigMin_ann_rcp26 = data_dict['bigMin_ann_rcp26']
    
    bigMin_ann_rcp26 = np.squeeze(np.array(bigMin_ann_rcp26))
    bigMin_ann_rcp26 = weight_mean(bigMin_ann_rcp26)

    with open('China_rcp26_tmin_weightmean.pkl', 'wb') as f:
        pickle.dump({'bigMin_ann_rcp26_weight': bigMin_ann_rcp26}, f, protocol = 4)
